    ...
    <section class="flex items-center hero">
        ...
        >
          <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
            Transforming <br class="" />Your Ideas
          </h1>
          <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
            Kami menyediakan berbagai buku dan sejenisnya yang 
            <br class="hidden lg:block" />menginspirasi pembaca & mewujudkan ide-ide mereka
          </h2>
          <div>
            <a
              href="#browse-the-book"
        ...
        <div class="w-full inset-0 md:relative md:w-1/2">
          <div class="relative hero-image">
              ...
              <button
                ...
                <div class="absolute w-full h-full">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/_1XP47lR43s" 
            ...
            <img
              src="{{ url('/frontend/images/content/image-section-1.jpg') }}"
              alt="hero 1"
        ...
        <div class="container mx-auto">
          <div class="flex flex-start mb-4">
            <h3 class="text-2xl capitalize font-semibold">
              browse the book <br class="" />that we provide for you
            </h3>
          </div>
          <div class="grid grid-rows-2 grid-cols-9 gap-4">
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="{{ url('/frontend/images/content/image-catalog-1.jpg') }}"
                  alt=""
              ...
              >
                <h5 class="text-lg font-semibold">Novel</h5>
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="{{ url('/frontend/images/content/image-catalog-3.jpg') }}"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
              ...
              >
                <h5 class="text-lg font-semibold">Comic</h5>
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="{{ url('/frontend/images/content/image-catalog-4.jpg') }}"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
              <div
                class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12"
              >
                <h5 class="text-lg font-semibold">Ensiklopedi</h5>
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-4 card">
              <div class="card-shadow rounded-xl">
                <img
                  src="{{ url('/frontend/images/content/image-catalog-2.jpg') }}"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
              <div
                class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72"
              >
                <h5 class="text-lg font-semibold">Antologi</h5>
      ...
      <section class="flex flex-col py-16">
        <div class="container mx-auto mb-4">
          <div class="flex justify-center text-center mb-4">
            <h3 class="text-2xl capitalize font-semibold">
              Our recommendation <br class="" />for You
            </h3>
          </div>
        </div>
